...
export default function HeightInputScreen() {
  ...
  const handleSubmit = () => {
    if (heightFt || heightCm) {
      const height = heightFt ? `${heightFt} ft` : `${heightCm} cm`;
      alert(`Height submitted: ${height}`);
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        <Text style={styles.label}>Enter height in feet (ft):</Text>
        <TextInput
          style={styles.input}
        ...
        <Text style={styles.label}>Or enter height in centimeters (cm):</Text>
        <TextInput
          style={styles.input}
          keyboardType="numeric"
          value={heightCm}
